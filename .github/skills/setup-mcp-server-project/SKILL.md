...
description: Set up a new MCP Server Python application. Add scaffoldings for a new MCP Server in this project. Utilize uv as package manager and FastMCP framework to build an MCP server.
---
## Overview
